...
##Work to do:   
Ej:  
    A-Star algorithm 2-way  
    Graphing info: nodes, edges etc  
    google maps api??
...
* Map
* Node
    Multiple types, "*" indicates a building, "+" indicates an intersection
* Path

##Goals and Timing:
* Working terminal mapping system --> showing correct graph 
features and connecting regions on a small area(trin>?) 
to show proof of concept
* Get working on app, either local hosting or public, make it functional to the users
